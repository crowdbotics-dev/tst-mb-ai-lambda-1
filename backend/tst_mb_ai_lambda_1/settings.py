"""
Django settings for tst_mb_ai_lambda_1 project.
...
ROOT_URLCONF = 'tst_mb_ai_lambda_1.urls'
...
WSGI_APPLICATION = 'tst_mb_ai_lambda_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_mb_ai_lambda_1 API",
    "DESCRIPTION": "API documentation for tst_mb_ai_lambda_1 App",
    "VERSION": "v1",
}
